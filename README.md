...
The functionality of the SHA2 algorithm is split into two distinct phases:

* **Phase one**<br>Take 64 bytes from the input file and from them, generate a 256 byte message digest
* **Phase two**<br>Process the message digest to update 8, 32-bit hash values
